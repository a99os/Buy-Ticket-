...
export class SeatTypeService {
  constructor(
    @InjectModel(Seat_Type) private seat_typeRepository: typeof Seat_Type,
  ) {}
  ...
  findAll() {
    return this.seat_typeRepository.findAll({ include: { all: true } });
  }
  ...
  async update(id: number, updateSeat_TypeDto: UpdateSeatTypeDto) {
    ...
    return this.seat_typeRepository.update(updateSeat_TypeDto, {
      where: { id },
    });
  }
